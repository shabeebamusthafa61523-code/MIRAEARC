...
import { Mail, Instagram, Copy, ExternalLink, ArrowRight, Compass } from 'lucide-react';
  ...
  return (
    <div className="h-screen w-screen overflow-hidden flex flex-col justify-between architectural-grid-light bg-slate-50 text-slate-900 font-sans selection:bg-orange-500 selection:text-white relative">
      ...
      <main className="w-full max-w-4xl mx-auto px-6 z-10 flex flex-col items-center text-center my-auto py-2">
        ...
        {/* Brand Logo Card */}
        <div className="w-full max-w-xl p-5 md:p-6 bg-white/90 backdrop-blur-md rounded-2xl border border-slate-200/90 shadow-md shadow-slate-200/60 mb-6">
          <img
            src="/logo.png"
            alt="MIRAE arc studio by PMR INFRA LLP"
            className="w-full h-auto max-h-[110px] md:max-h-[135px] object-contain mx-auto"
          />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl">
          ...
          <div
            ...
            className="group bg-white/90 hover:bg-white p-4.5 rounded-xl flex flex-col justify-between text-left cursor-pointer border border-slate-200 shadow-xs hover:shadow-md hover:border-orange-400 transition-all block"
          >
            <div className="flex items-start justify-between mb-3">
              <div className="w-10 h-10 rounded-lg bg-orange-50 border border-orange-100 flex items-center justify-center text-orange-600 group-hover:scale-105 transition-transform">
          ...
          <a
            ...
            className="group bg-white/90 hover:bg-white p-4.5 rounded-xl flex flex-col justify-between text-left cursor-pointer border border-slate-200 shadow-xs hover:shadow-md hover:border-rose-400 transition-all block"
          >
            <div className="flex items-start justify-between mb-3">
              <div className="w-10 h-10 rounded-lg bg-rose-50 border border-rose-100 flex items-center justify-center text-rose-600 group-hover:scale-105 transition-transform">
