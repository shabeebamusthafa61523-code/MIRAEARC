...
import { Mail, Instagram, Copy, ExternalLink, ArrowRight, Sparkles, Compass } from 'lucide-react';
  ...
  return (
    <div className="h-screen w-screen overflow-hidden flex flex-col justify-between architectural-grid-light bg-slate-50 text-slate-900 font-sans selection:bg-orange-500 selection:text-white relative">
      ...
      <main className="w-full max-w-4xl mx-auto px-6 z-10 flex flex-col items-center text-center my-auto py-2">
        ...
        {/* Brand Logo Card */}
        <div className="w-full max-w-xl p-5 md:p-6 bg-white/90 backdrop-blur-md rounded-2xl border border-slate-200/90 shadow-md shadow-slate-200/60 mb-5">
          <img
            src="/logo.png"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl mb-6">
          ...
          <div
            ...
            className="group bg-white/90 hover:bg-white p-4 rounded-xl flex flex-col justify-between text-left cursor-pointer border border-slate-200 shadow-xs hover:shadow-md hover:border-orange-400 transition-all block"
          >
          ...
          <a
            ...
            className="group bg-white/90 hover:bg-white p-4 rounded-xl flex flex-col justify-between text-left cursor-pointer border border-slate-200 shadow-xs hover:shadow-md hover:border-rose-400 transition-all block"
          >
            <div className="flex items-start justify-between mb-2">
        ...
        <button
          onClick={() => setIsModalOpen(true)}
          className="px-6 py-2.5 rounded-xl bg-slate-900 hover:bg-black text-white font-medium text-xs sm:text-sm transition-all shadow-sm hover:shadow flex items-center gap-2 group cursor-pointer"
        >
